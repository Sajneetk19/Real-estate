  ...
  return (
    <section>
      <div className='container mx-auto min-h-[600px] mb-14'>
        ...
        <div className='flex-1 bg-white w-full b-8 border border-gray-300 rounded-lg px-6 py-8'>
